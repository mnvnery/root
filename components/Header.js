...
const Header = ({colour, bgColour}) => {
    ...
    return (
        <>
        <div className={`sticky top-0 px-7 xxl:px-16 bg-${bgColour} z-10`}>
            <div className={`flex justify-between items-center border-b border-${colour} text-${colour} py-5`}>
                <Link href='/'>
                <div className="relative w-5 h-8 md:w-7 md:h-12 cursor-pointer">
